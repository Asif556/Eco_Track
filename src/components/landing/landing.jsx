...
function Landing() {
  ...
  return (
    <div className="w-screen relative bg-[radial-gradient(ellipse_at_center,#C0F2CB_10%,#A0D8B3_40%,_transparent_90%)]">
      <div className="h-full w-full flex flex-wrap p-6">
        ...
        <button 
          className="bg-[#082B13] ml-auto text-white text-xl h-12 rounded-3xl px-6 flex cursor-pointer gap-2 items-center justify-center hover:bg-[#C0F2CB] hover:text-[#2BA84A]"
          onClick={() => navigate('/login')}
        >
          Login <img src="pointer.svg" alt="" className="w-8 " />
        </button>
      </div>
      ...
      {/* Main Image */}
      <div>
        <img src="landingfull.svg" alt="" className="ml-80 mt-[-1rem]" />
      </div>
      
      {/* Randomly Placed Small Images */}
      <img src="water.svg" alt="Water" className="absolute top-20 left-20 w-6 opacity-80" />
      <img src="rose.svg" alt="Rose" className="absolute top-40 right-32 w-8 opacity-80" />
